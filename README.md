...
`kubectl port-forward deployment/typhon-polystore-service-deployment 8080:8080 --namespace typhon`

`kubectl port-forward deployment/polystore-ui-deployment 4200:4200 --namespace typhon`

`kubectl port-forward service/typhon-cluster-kafka-external-bootstrap 9094:9094 --namespace typhon`

`kubectl port-forward service/typhon-cluster-zookeeper-client 2181:2181 --namespace typhon`

`kubectl port-forward service/flink-jobmanager 8081:8081 --namespace typhon`
