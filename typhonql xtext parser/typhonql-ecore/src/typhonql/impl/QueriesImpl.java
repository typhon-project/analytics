 ...
 * </p>
 * <ul>
 *   <li>{@link typhonql.impl.QueriesImpl#getQueries <em>Queries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueriesImpl extends EObjectImpl implements Queries {
	...
	protected EClass eStaticClass() {
		return TyphonqlPackage.Literals.QUERIES;
	}
	...
	public EList<Query> getQueries() {
		if (queries == null) {
			queries = new EObjectContainmentEList<Query>(Query.class, this, TyphonqlPackage.QUERIES__QUERIES);
		}
		return queries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TyphonqlPackage.QUERIES__QUERIES:
