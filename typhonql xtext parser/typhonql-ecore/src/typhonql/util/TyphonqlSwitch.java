 ...
 * @generated
 */
public class TyphonqlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TyphonqlPackage.INSERT: {
				...
				if (result == null) result = caseQuery(insert);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TyphonqlPackage.DELETE: {
				...
				if (result == null) result = caseQuery(delete);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TyphonqlPackage.UPDATE: {
				...
				if (result == null) result = caseQuery(update);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TyphonqlPackage.OBJ: {
				...
				if (result == null) result = caseExpr(obj);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
