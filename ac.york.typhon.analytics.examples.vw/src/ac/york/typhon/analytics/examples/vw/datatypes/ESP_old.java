...
public class ESP_old {
	...
	ArrayList<VehicleMetadata_old> metadata;
	
	public ArrayList<VehicleMetadata_old> getMetadata() {
		return metadata;
	}
	public void setMetadata(ArrayList<VehicleMetadata_old> metadata) {
	...
	public GeoPoint_old getVehicle_position() {
		return vehicle_position;
	}
	public void setVehicle_position(GeoPoint_old vehicle_position) {
