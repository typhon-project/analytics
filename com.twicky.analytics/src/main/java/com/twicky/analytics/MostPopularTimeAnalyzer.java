...
import com.twicky.analytics.assigner.BoundedOutOfOrdernessGeneratorForMostPopularTime;
...
//				System.out.println(" NOT an update");
		...
		.assignTimestampsAndWatermarks(new BoundedOutOfOrdernessGeneratorForMostPopularTime())
