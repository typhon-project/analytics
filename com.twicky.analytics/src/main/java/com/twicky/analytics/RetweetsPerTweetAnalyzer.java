...
public class RetweetsPerTweetAnalyzer extends StreamAnalyzer {
	...
	public DataStream<Event> analyse(DataStream<Event> eventsStream)
		...
		eventsStream
				...
				.flatMap(
						new FlatMapFunction<TweetDTO, Tuple2<String, Integer>>() {
							...
							public void flatMap(TweetDTO value,
								...
								Integer retweetCount = NumberUtils
										.createInteger(value.getRetweetCount());
								out.collect(new Tuple2<String, Integer>(value
										.getId(), Objects.equals(retweetCount,
										null) ? 0 : retweetCount));
				...
				.keyBy(0)
				.windowAll(TumblingEventTimeWindows.of(Time.seconds(1800)))
