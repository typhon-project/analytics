...
public class TopMerchantsCountAnalyzer implements IAnalyzer {
		...
		postEvents
				...
				.map(new MapFunction<Event, FinancialEvent>() {
					...
					public FinancialEvent map(Event event) throws Exception {
						FinancialEventInsertExtractor extractor = new FinancialEventInsertExtractor(
								event.getQuery());
				...
				//
				// @Override
				// public void invoke(Tuple3<String, String, Long> value) throws
				// Exception {
				// // TODO Auto-generated method stub
				// SinkFunction.super.invoke(value);
				// ArrayList<Tuple3<String,String,Long>> allTuples = new
				// ArrayList<Tuple3<String,String,Long>>();
				// allTuples.add(value);
				...
				//
				// @Override
				// public ArrayList<Tuple3<String, String, Long>>
				// map(Tuple3<String, String, Long> arg0) throws Exception {
				// allTuples.add(arg0);
				// return allTuples;
				// }
				// })
	...
	public class MyProcessWindowFunction
			extends
			ProcessWindowFunction<FinancialEvent, Tuple3<String, String, Long>, Tuple, TimeWindow> {
	...
	public class CategoriesCountTuple implements
			Comparable<CategoriesCountTuple> {
