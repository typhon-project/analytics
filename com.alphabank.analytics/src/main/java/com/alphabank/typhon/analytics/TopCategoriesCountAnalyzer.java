...
public class TopCategoriesCountAnalyzer implements IAnalyzer {

	private static Connection connection;

	@Override
	public DataStream<Event> analyze(DataStream<Event> postEvents) throws Exception {
			...
			public FinancialEvent map(Event event) throws Exception {
				...
				.map(new MapFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>>() {
					...
					public Tuple3<String, String, Long> map(Tuple3<String, String, Long> arg0) throws Exception {
						...
						String query = "insert into TopCategoriesCountResults (category_name, month_year, count)"
								+ " values (?, ?, ?)";
